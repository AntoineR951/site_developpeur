    ...
    <div className="bg-[#0C0C0C] text-[#F5F5F5] min-h-screen selection:bg-[#E8C547] selection:text-black">
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-display font-bold mb-12">Mentions Légales</h1>
                                                        ...
                                                        <h4>Glossaire</h4>
<ul>
<li>Utilisateur : Internaute se connectant, utilisant le site <b>www.antoine-rousseau.fr</b></li>
...
<p>En vertu de l’article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l’économie numérique, il est précisé aux utilisateurs du site <b>www.antoine-rousseau.fr</b> l’identité des différents intervenants dans le cadre de sa réalisation et de son suivi :</p>
<ul>
<li>Responsable publication, créateur et propriétaire du site : Antoine Rousseau contact (at) antoine-rousseau.fr</li>
<li>Nom de l’entreprise : ABC PROGRAMMATION</li>
<li>Siret : 93937030000013</li>
<li>Numéro de TVA intracommunautaire : FR79939370300</li>
<li>Numéro RCS :  Paris B 939 370 300</li>
<li>Date d’immatriculation : 01/01/2025 (auparavant immatriculé en entreprise individuelle avec le SIREN 532 828 324) </li>
<li>Adresse : 10 rue de Penthièvre 75008 Paris</li>
<li>Mail responsable publication : contact (at) antoine-rousseau.fr</li>
<li>Hébergeur : OVH – 2 rue Kellermann – 59100 ROUBAIX – France</li>
</ul>
<h4>Propriétaire du site</h4>
<p>Antoine Rousseau, propriétaire et créateur du site, se réserve le droit de modifier et de mettre à jour, sans préavis, les présentes Conditions Générales et tous les éléments, produits ou services présentés sur le site.</p>
<p>Antoine Rousseau est enregistré auprès de l’INSEE sous le numéro de SIRET 532 828 324 00030 possède le statut d’entrepreneur individuel et est domicilié à 10 rue de Penthièvre 75008 Paris.</p>
<h4>Informations personnelles collectées</h4>
<p>En France, les données personnelles sont notamment protégées par la loi n° 78-87 du 6 janvier 1978, la loi n° 2004-801 du 6 août 2004, l’article L. 226-13 du Code pénal et la Directive Européenne du 24 octobre 1995.</p>
<p>En tout état de cause <b>www.antoine-rousseau.fr</b> ne collecte des informations personnelles relatives à l’utilisateur (nom, adresse électronique, coordonnées téléphoniques) que lors de l’utilisation du formulaire de contact présent sur la page de contact du site <b>www.antoine-rousseau.fr</b>. L’utilisateur fournit ces informations en toute connaissance de cause, notamment lorsqu’il procède par lui-même à leur saisie.<br>
Il est alors précisé à l’utilisateur du site <b>www.antoine-rousseau.fr</b> le caractère obligatoire ou non des informations qu’il serait amené à fournir.</p>
<p>Les informations transmises via le formulaire de contact ne sont pas enregistrées dans une base de données et ne font l’objet d’aucun traitement, elles sont simplement transmises par mail au propriétaire du site pour permettre à la personne qui fait la demande d’être recontactée et uniquement à cette fin. Ces informations sont conservées dans la boite mail du propriétaire du site pendant une durée de 12 mois.  Vous disposez d’un droit de modification et de suppression des données vous concernant (art. 34 de la loi «&nbsp;Informatique et Libertés&nbsp;»). Pour l’exercer, adressez vous à contact (at) antoine-rousseau.fr.</p>
<p>Aucune information personnelle de l’utilisateur du site <b>www.antoine-rousseau.fr</b> n’est :</p>
<ul>
...
<p>Au démeurant <b>www.antoine-rousseau.fr</b> est autorisé à effectuer des études et analyses statistiques sur l’utilisation des utilisateurs du site <b>www.antoine-rousseau.fr</b>, sous réserve de confirmer l’anonymat de ces derniers.</p>
<h4>Cookies</h4>
<p>Un « Cookie » permet l’identification de l’utilisateur, la personnalisation de sa consultation du site <b>www.antoine-rousseau.fr</b> et l’accélération de la mise en page du site grâce à l’enregistrement d’un léger fichier de données sur son ordinateur.<br>
L’utilisateur reconnaît être informé de cette pratique et autorise <b>www.antoine-rousseau.fr</b> à y procéder.<br>
En tout état de cause <b>www.antoine-rousseau.fr</b> s’engage à ne jamais communiquer le contenu de ces « Cookies » à des tierces personnes, sauf en cas de réquisition légale.<br>
L’utilisateur peut refuser l’enregistrement de « Cookies » ou configurer son navigateur pour être prévenu préalablement à l’acception les « Cookies ». Pour ce faire, l’utilisateur procédera au paramétrage de son navigateur à partir du menu « outil » pour Microsoft Internet Explorer 5 ou 6.0, ou du menu « Edition » pour Netscape 6 ou 7.</p>
<h4>Marques</h4>
<p>Les marques et logos contenus dans le site <b>www.antoine-rousseau.fr</b> sont déposés par <b>www.antoine-rousseau.fr</b>. A ce titre, toute personne procédant à leurs représentations, reproductions, imbrications, diffusions et rediffusions encourt les sanctions prévues aux articles L. 713-2 et suivants du Code de la propriété intellectuelle.</p>
<h4>Observations et suggestions</h4>
<p>Il est possible de transmettre des observations et des suggestions au responsable du site à l’adresse électronique <b>contact (at) antoine-rousseau.fr</b>.</p>
...
<p>Antoine Rousseau, propriétaire du site, est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur tous les éléments accessibles sur le site, notamment les textes, images, graphismes, logo, icônes, sons, logiciels.</p>
<p>Toute reproduction, représentation, modification, publication, adaptation de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de : Antoine Rousseau.</p>
<p>Toute exploitation non autorisée du site ou de l’un quelconque des éléments qu’il contient sera considérée comme constitutive d’une contrefaçon et poursuivie conformément aux dispositions des articles L.335-2 et suivants du Code de Propriété Intellectuelle.</p>
<h4>Limitations de responsabilité</h4>
<p>Antoine Rousseau ne pourra être tenu responsable des dommages directs et indirects causés au matériel de l’utilisateur, lors de l’accès au site <b>www.antoine-rousseau.fr</b>, et résultant soit de l’utilisation d’un matériel ne répondant pas aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou d’une incompatibilité.</p>
<p>Antoine Rousseau&nbsp;ne pourra également être tenu responsable des dommages indirects (tels par exemple qu’une perte de marché ou perte d’une chance) consécutifs à l’utilisation du site <b>www.antoine-rousseau.fr</b>.</p>
<p>Antoine Rousseau&nbsp;se réserve le droit de supprimer, sans mise en demeure préalable, tout contenu publié en tant que commentaire qui contreviendrait à la législation applicable en France, en particulier aux dispositions relatives à la protection des données. Le cas échéant, Antoine Rousseau&nbsp;se réserve également la possibilité de mettre en cause la responsabilité civile et/ou pénale de l’utilisateur, notamment en cas de message à caractère raciste, injurieux, diffamant, ou pornographique, quel que soit le support utilisé (texte, photographie…).</p>
<h4>Droit applicable et attribution de juridiction</h4>
<p>Le site <b>www.antoine-rousseau.fr</b> étant hébergé par un hébergeur français, tout litige en relation avec son utilisation est soumis au droit français. Il est fait attribution exclusive de juridiction aux tribunaux compétents de Paris.</p>
