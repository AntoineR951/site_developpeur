...
const allTestimonials = [
    { text: "Société très sérieuse et Mr Rousseau est très compétent, il maîtrise très bien son travail (digital, outil informatique et référencement marketing). Je recommande sans hésitation !", author: "Sofiane A." },
    { text: "Le professionnalisme, la rigueur et disponibilité de Monsieur Rousseau sont autant d'atouts pour mener à bien la création de site confiée. Il a su adapter les outils à ma demande et résoudre les difficultés techniques. Je recommande ses services.", author: "Chrystele V." },
    { text: "Merci beaucoup pour votre diligence, votre patience et disponibilité pour régler les différents types de problèmes de notre site internet. J'apprécie énormément !", author: "Arthur R.A." },
    { text: "Bravo, il a réalisé un site internet pour notre entreprise, merci à vous", author: "My Ostal" },
    { text: "Bravo à vous, nous l'avions contacté pour la création d'un site pour notre société. Cela a été réalisé avec un grand professionnalisme", author: "Dylan R.D." },
    { text: "Bravo, professionnel très réactif et à l'écoute ! Notre site internet a été réalisé en un rien de temps :) merci à vous", author: "Dylan D." },
    { text: "Antoine a réalisé deux sites pour mon compte, celui de mon activité libérale puis mon site personnel. Le travail réalisé est de grande qualité, tant au niveau de la technique que de l'esthétisme du site. De plus, sérieux, Antoine est d'une grande réactivité et à l'écoute. Je le recommande sans hésiter.", author: "Laurent G." },
    { text: "Prestataire sérieux, professionnel et rigoureux ! Très satisfaite des services de Mr Rousseau. Il a su comprendre nos besoins et a pu nous livrer un site sur mesure. Toujours disponible, son professionnalisme et sa rigueur sont très appréciés. Je recommande fortement ses services !", author: "Sabrina H." },
    { text: "Mr Rousseau a été très réactif pour la création de notre site internet. Il est très à l'écoute et toujours très disponible. Je le recommande sans problème!", author: "Julie P." },
    { text: "Antoine Rousseau est un développeur très sérieux qui m'a construit mon site en 2022 et qui fonctionne très bien. En outre, il assure un suivi de qualité. Je recommande ses services en toute confiance.", author: "Cédric T." },
    { text: "Antoine a su être à l'écoute, réactif et source de propositions. Je recommande. Il a réalisé pour moi un site propre et dans un très bon délai d'exécution", author: "Solène C." },
    { text: "Très bonne expérience avec Antoine Rousseau à propos de la création de mon site internet. Il m'a donné de bons conseils pour optimiser la visibilité du site et est réactif lors d'une demande de modification quelconque. Je recommande sans soucis ce professionnel.", author: "Mélanie C." },
    { text: "Très satisfait des services de Mr Rousseau. Il est une personne qualifiée et s'est montré très disponible lors de la création de mon site web. Je recommande fortement ses services!", author: "Julien C." },
    { text: "Très satisfait de la prestation de Mr Rousseau. Il suit mon site depuis 2017. Une personne très technique, très professionnelle et disponible. Je vous recommande ses services.", author: "Abdelali B." },
    { text: "3i3s-Europa est et sera d'une reconnaissance sans faille pour Mr Antoine ROUSSEAU. Non seulement il a sauvé notre site piraté mais en plus il l'a rajeuni et l'a équipé de nouvelles fonctionnalités. Sa disponibilité est impressionnante, son professionnalisme irréprochable et le coût de ses prestations nettement inférieur au marché.", author: "Philippe B." },
    { text: "Monsieur Rousseau a parfaitement répondu à mon attente, tant dans le contenu du site que dans sa forme, grâce à une grande écoute et beaucoup de réactivité à chaque étape de sa création. J'ai désormais en première page de Google une vitrine très claire et ergonomique pour mon activité.", author: "Arlette D." },
    { text: "Mr ROUSSEAU c'est la valeur sûre, l'assurance d'un travail de qualité et ceci dans les plus brefs délais. J'ai été frappée par son professionnalisme lors de la conception de mon site de coaching parental Ghisly Conseil. Je vous le recommande vivement", author: "Ghis D." },
];
